...
struct Yolov8Inference_
{
  ...
  using _yolov8_inference_type =
    std::vector<yolov8_msgs::msg::InferenceResult_<ContainerAllocator>, typename ContainerAllocator::template rebind<yolov8_msgs::msg::InferenceResult_<ContainerAllocator>>::other>;
  ...
  Type & set__yolov8_inference(
    const std::vector<yolov8_msgs::msg::InferenceResult_<ContainerAllocator>, typename ContainerAllocator::template rebind<yolov8_msgs::msg::InferenceResult_<ContainerAllocator>>::other> & _arg)
  {
